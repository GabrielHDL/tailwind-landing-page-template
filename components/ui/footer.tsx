...
import LatoLogo from "@/public/images/mini-footer-color.svg";
  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        {/* Top area: Blocks */}
        <div
          className={`grid gap-10 py-10 sm:grid-cols-12 md:py-12 ${border ? "border-t [border-image:linear-gradient(to_right,transparent,var(--color-slate-200),transparent)1]" : ""}`}
        >
          {/* 1st block */}
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; Hecsacapital - Todos los derechos reservados.
            </div>
          </div>
          ...
          {/* 3rd block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Compañia</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  className="text-gray-600 transition hover:text-gray-900"
          ...
          {/* 4th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Otras compañias</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  target="_blank"
                  className="text-gray-600 transition hover:text-gray-900"
                  href="https://superpostes.la"
                >
                  Superpostes
                </Link>
              </li>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Diseño y desarrollo</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  target="_blank"
                  className="text-gray-600 transition hover:text-gray-900"
                  href="https://lato.agency"
                >
                  <Image
                    src={LatoLogo}
                    alt="Lato Agency"
            ...
            <ul className="flex gap-2">
              <li>
                <Link
                  ...
                  href="tel:+525616335840"
                  aria-label="Phone"
                >
                  <FiPhone className="text-secondary transition hover:text-primary" />
                </Link>
              </li>
              <li>
                <Link
                  target="_blank"
                  className="flex items-center justify-center"
                  href="https://wa.me/525616335840"
                  aria-label="Whatsapp"
                >
                  <FaWhatsapp className="text-secondary transition hover:text-primary" />
                </Link>
              </li>
              {/* <li>
                <Link
